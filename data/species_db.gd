...
const DATA: Dictionary = {
	...
	DIENTUDO: {
		...
		"spawn_weight_min_g": 105.0,
		"spawn_weight_max_g": 135.0,
		"base_points": 10.0,
		"top_speed": 180.0,
		"is_predator": true,
		"prey_weight_ratio_limit": 1.0,
		...
		"dart_wind_up_seconds": 0.2,
		"dart_duration_seconds": 0.85,
		"dart_cooldown_seconds": 2.2,
		"dash_speed_multiplier": 2.35,
		"dash_turn_rate_factor": 1.1,
		"dash_abort_edge_distance_factor": 0.35,
		"boid_weights": {
			"separation": 1.6,
			"alignment": 0.6,
			"cohesion": 0.25
