...
var feeding_start_distance: float = 54.0
var feeding_chance_per_second: float = 0.8
var feeding_energy_ratio: float = 0.92
var feeding_energy_gain: float = 1.35
var feed_lock_seconds: float = 8.0
...
var despawner_avoid_radius: float = 240.0
var despawner_avoid_force_multiplier: float = 2.35
var spawn_egress_lock_seconds: float = 3.4
var spawn_egress_lock_remaining: float = 0.0
var repel_zone_feed_margin: float = 24.0
var upper_zone_ratio: float = 0.34
var stall_speed_ratio_threshold: float = 0.16
var stall_trigger_seconds: float = 1.0
var unstuck_boost_seconds: float = 2.0
var unstuck_force_multiplier: float = 1.7
var stalled_time: float = 0.0
var unstuck_boost_remaining: float = 0.0
var unstuck_zone_lock: bool = false
var turn_rate_rad_per_sec: float = 2.8
var turn_slow_min_speed_factor: float = 1.0
var local_separation_strength: float = 2.2
var local_separation_radius: float = 42.0
var panic_duration_seconds: float = 1.0
var panic_cooldown_seconds: float = 5.0
var panic_speed_multiplier: float = 2.0
...
func _apply_sabalo_defaults() -> void:
	var species_data: Dictionary = SpeciesDB.get_species(SpeciesDB.SABALO)
